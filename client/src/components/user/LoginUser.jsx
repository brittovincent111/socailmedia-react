                                    ...
                                    <div class="w-full ">
                                        <div class="bg-gray-100 flex flex-col justify-center items-center  h-max py-3 rounded text-center">
                                            ...
                                            <div class="flex justify-center text-center items-center space-x-3 mt-5">
                                                {resend ?
                                                    <button onClick={(e) => { sendMail() }} class="px-4 py-2 bg-blue-300 flex items-center text-white hover:bg-blue-300 cursor-pointer" ><span class="font-bold">Send</span><i class='bx bx-caret-right ml-1'></i></button>

                                                    : <button class="px-4 py-2 bg-blue-700 flex items-center text-white hover:bg-blue-900 cursor-pointer"><span class="font-bold">Cancel</span><i class='bx bx-caret-right ml-1'></i></button>
                                                }
                                            </div>                       
                                        </div>
                                    </div>
