...
export default function UserReportDetailView() {
    ...
    console.log(userDetails ,userId, "postDetsiddddd")
    ...
    return (
        ...
        <div className='bg-gray-200 h-screen' >
            <div class="container mx-auto px-4 sm:px-8">
                <div class="py-8">
                    <div>
                        <h2 class="text-2xl font-semibold leading-tight">DETAIL REPORTS</h2>
                    </div>
                                        ...
                                        userDetails.map((obj, index) => {
                                            ...
                                            return (
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="text-center">{obj.reporterId.username}</td>
