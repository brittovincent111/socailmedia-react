...
import moment from 'moment'
 ...
 export default function ReportedPosts() {
    ...
    useEffect(() => {
        ...
        Axios.get('http://localhost:4000/admin/report/postmanagment', { headers: { "x-access-token": localStorage.getItem("Admintoken") } }).then((response) => {
                                        ...
                                        postDetails.map((obj, index) => {
                                            ...
                                            return (
                                                ...
                                                <tr>
                                                    ...
                                                    <Link to={`/admin/viewreport/postmanagment/${obj._id}`} ><td className="text-center">view</td></Link>
